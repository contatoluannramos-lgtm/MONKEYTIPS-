        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTips.map((tip) => (
              <div key={tip.id} className="bg-surface-900/30 backdrop-blur-md border border-white/5 hover:border-brand-500/50 transition-all duration-300 group flex flex-col">
                ...
                <div className="h-[2px] w-full bg-surface-800">
                  <div 
                    className="h-full bg-brand-500 transition-all duration-1000 ease-out shadow-[0_0_10px_rgba(245,158,11,0.5)]" 
